...
import br.com.rpires.dao.EstoqueProdutoDAO;
import br.com.rpires.dao.IClienteDAO;
import br.com.rpires.dao.IEstoqueProdutoDAO;
...
public class VendaDAOTest {
	...
	private void excluirEstoqueProdutos() throws DAOException {
		Collection<EstoqueProduto> list = this.estoqueProdutoDAO.buscarTodos();
		for (EstoqueProduto prod : list) {
			this.estoqueProdutoDAO.excluir(prod.getCadastro());
		}
	}
	...
	private EstoqueProduto cadastrarEstoqueProduto(Produto produto) throws TipoChaveNaoEncontradaException, DAOException {
		estoqueProduto = new EstoqueProduto();
		estoqueProduto.setProduto(produto);
		estoqueProduto.setQuantidade(100);
		estoqueProduto.setCadastro(123456L);
